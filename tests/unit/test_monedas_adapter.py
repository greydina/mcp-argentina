...
def mock_todas_monedas():
    ...
    return [
        {"moneda": "USD", "nombre": "Dólar", "compra": 950, "venta": 1000, "fechaActualizacion": "2026-03-29T12:00:00.000Z"},
        {"moneda": "EUR", "nombre": "Euro", "compra": 1500, "venta": 1520, "fechaActualizacion": "2026-03-29T12:00:00.000Z"},
        {"moneda": "BRL", "nombre": "Real", "compra": 260, "venta": 265, "fechaActualizacion": "2026-03-29T12:00:00.000Z"},
        {"moneda": "UYU", "nombre": "Peso Uruguayo", "compra": 25, "venta": 26, "fechaActualizacion": "2026-03-29T12:00:00.000Z"},
    ]
...
class TestMonedasAdapter:
    ...
    @pytest.mark.asyncio
    async def test_obtener_moneda_euro(
    ...
    @pytest.mark.asyncio
    async def test_obtener_todas(
        self, httpx_mock: HTTPXMock, mock_todas_monedas
    ) -> None:
