...
class TestAlertasService:
    ...
    def test_configurar_alerta_reemplaza_existente(self, mock_repository) -> None:
        ...
        service.configurar_alerta(ConfiguracionAlerta(cotizacion="blue", umbral_porcentual=5.0))
        service.configurar_alerta(ConfiguracionAlerta(cotizacion="blue", umbral_porcentual=10.0))
    ...
    @pytest.mark.asyncio
    async def test_verificar_alerta_sin_cambio(self, mock_repository, cotizacion_blue) -> None:
        ...
        _ = await service.verificar_alertas()
    ...
    @pytest.mark.asyncio
    async def test_verificar_alerta_umbral_superado(self, mock_repository) -> None:
        ...
        service = AlertasService(mock_repository)
        service.configurar_alerta(ConfiguracionAlerta(cotizacion="blue", valor_maximo=1500.0))
    ...
    @pytest.mark.asyncio
    async def test_callback_se_llama(self, mock_repository) -> None:
